...
CREATE TABLE IF NOT EXISTS `education`.`faculty_member` (
  ...
  `update_time` DATETIME NULL,
  `user_iduser` INT NOT NULL,
  PRIMARY KEY (`id`, `department_iddepartment`),
...
CREATE TABLE IF NOT EXISTS `education`.`academic_transcript` (
  ...
  PRIMARY KEY (`id`, `sum_dagree`, `sub_group_idsub_group`),
  UNIQUE INDEX `idacademy-std-Pstage_UNIQUE` (`id` ASC),
...
CREATE TABLE IF NOT EXISTS `education`.`semester` (
  ...
  `user_iduser` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_semester_user1_idx` (`user_iduser` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `education`.`sub_group` (
  ...
  `user_iduser` INT NOT NULL,
  PRIMARY KEY (`id`, `subject_idsubject`, `semester_idsemester`),
  ...
  INDEX `fk_sub_group_user1_idx` (`user_iduser` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `education`.`timeline` (
  ...
  `user_iduser` INT NOT NULL,
  PRIMARY KEY (`id`, `semester_idsemester`, `sub_group_idsub_group`, `subject_idsubject`),
  ...
  INDEX `fk_timeline_user1_idx` (`user_iduser` ASC))
ENGINE = InnoDB;
